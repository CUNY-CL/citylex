...
_ENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subtlex_uk_freq', full_name='citylex.Entry.subtlex_uk_freq', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subtlex_uk_cd', full_name='citylex.Entry.subtlex_uk_cd', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subtlex_us_freq', full_name='citylex.Entry.subtlex_us_freq', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subtlex_us_cd', full_name='citylex.Entry.subtlex_us_cd', index=8,
