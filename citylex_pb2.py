...
_ENTRY_MORPHTRIPLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="lemma",
            full_name="citylex.Entry.MorphTriple.lemma",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="features",
            full_name="citylex.Entry.MorphTriple.features",
            index=1,
            number=3,
            type=9,
            cpp_type=9,
...
_ENTRY_SEGMENTATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="segmentation",
            full_name="citylex.Entry.Segmentation.segmentation",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="nmorph",
            full_name="citylex.Entry.Segmentation.nmorph",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_ENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="celex_morph",
            full_name="citylex.Entry.celex_morph",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="cmudict_pron",
            full_name="citylex.Entry.cmudict_pron",
            index=11,
            number=12,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="wikipron_uk_pron",
            full_name="citylex.Entry.wikipron_uk_pron",
            index=12,
            number=13,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="wikipron_us_pron",
            full_name="citylex.Entry.wikipron_us_pron",
            index=13,
            number=14,
            type=9,
            cpp_type=9,
...
Entry = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "MorphTriple": _reflection.GeneratedProtocolMessageType(
            "MorphTriple",
            (_message.Message,),
            {
